mysql> SELECT UPPER(REVERSE('Why does my cat look at me with such hatred?')) as title;
+----------------------------------------------+
| title                                        |
+----------------------------------------------+
...
mysql> SELECT author_fname as forwards, REVERSE(anthor_fname) as backwards FROM books;
ERROR 1054 (42S22): Unknown column 'anthor_fname' in 'field list'
